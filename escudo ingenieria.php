...
<head>
    ...
    <!-- Titulo
    ============================================= -->
	<title>Facultad de Ingeniería / Imagen Institucional</title>
                        ...
                        <ul>
                            ...
                            <li><a href="#"><div>Nuestra Facultad <img src="../images/icons/mainsubmenured2.png" alt="Submenu"></div></a>
                            	<ul>
                                    ...
                                    <li><a href="http://consejofi.fi-a.unam.mx" target="_blank"><div>Consejo Técnico</div></a></li>
                                    <li><a href="#"><div>Secretarías y Coordinaciones</div></a>
                                    	<ul>
                                            <li><a href="http://www.ingenieria.unam.mx/sgeneral/" target="_blank"><div>Secretaría General</div></a></li>
                                            <li><a href="https://ssa.ingenieria.unam.mx/" target="_blank"><div>Secretaría de Servicios Académicos</div></a></li>
                                            <li><a href="http://www.ingenieria.unam.mx/sadfi/" target="_blank"><div>Secretaría de Apoyo a la Docencia</div></a></li>
                                            <li><a href="http://www.secadminfi.unam.mx/" target="_blank"><div>Secretaría Administrativa</div></a></li>
                                            <li><a href="http://www.ingenieria.unam.mx/spifi/" target="_blank"><div>Secretaría de Posgrado e Investigación</div></a></li>
                                            <li><a href="../vinculacion/coordinacion_vinculacion.php" target="_blank"><div class="menulargo">Coordinación de Vinculación Productiva y Social</div></a></li>
                                    ...
                                    <li><a href="#"><div>Divisiones Académicas</div></a>
                                    	<ul>
                                            <li><a href="http://dcb.fi-c.unam.mx/" target="_blank"><div>División de Ciencias Básicas</div></a></li>
                                            <li><a href="http://dicyg.fi-c.unam.mx" target="_blank"><div>División de Ingenierías Civil y Geomática</div></a></li>
                   	                ...
                   	                <li><a href="http://www.ingenieria.unam.mx/uat/" target="_blank"><div>Unidad de Alta Tecnología</div></a></li>
                                	<li><a href="../nuestra_facultad/funcionarios.php">
                                    ...
                                    <li><a href="#"><div>Información institucional</div></a>
                                    	<ul>
                                    		...
                                    		<li><a href="http://www.ingenieria.unam.mx/planeacion/paginas/docsconsulta.html" target="_blank"><div>Informes y documentos de consulta</div></a></li>
                                    ...
                                    <li><a href="#"><div>Marco histórico</div></a>
                                    	<ul>
                                            ...
                                            <!--<li><a href="../nuestra_facultad/egresados_distinguidos.php"><div>Egresados distinguidos</div></a></li>-->
                                     ...
                                     <li><a href="http://www.secadminfi.unam.mx/SecAdmin" target="_blank"><div>Servicios administrativos</div></a>
                                     	<ul>
                                    		...
                                    		<li><a href="http://www.administracion.ingenieria.unam.mx/opinion.html" target="_blank"><div>Buzón de opinión del usuario</div></a></li>
                                    	</ul>
                                     </li>
                                </ul>
                            	...
                            	<ul>
                                	<li><a href="#"><div>Alumnos</div></a>
                                    	<ul>
                                            ...
                                            <li><a href="http://movilidad.ingenieria.unam.mx" target="_blank"><div>Movilidad estudiantil</div></a></li>
                                            <li><a href="#"><div>Asuntos escolares</div></a>
                                                <ul>
                                                    ...
                                                    <li><a href="http://servacad.ingenieria.unam.mx/escolar/servicios/" target="_blank"><div>Servicios escolares</div></a></li><li><a href="https://ssa.ingenieria.unam.mx/edocente.html" target="_blank">
                                                      ...
                                                      <li><a href="https://ssa.ingenieria.unam.mx/extraordinarios.html" target="_blank">
                                                      <div>Extraordinarios</div></a></li>
                                                    <li><a href="http://servacad.ingenieria.unam.mx/escolar/f306/" target="_blank"><div>Inscripción de asignaturas en otro plantel</div></a></li>
                                            ...
                                            <li><a href="#"><div>Cómputo</div></a>
                                                <ul>
                                                    <li><a href="http://www.ingenieria.unam.mx/~unica/" target="_blank"><div class="menulargo">Unidad de Servicios de Cómputo Académico (UNICA)</div></a></li>
                                                    <li><a href="http://proteco.mx" target="_blank"><div class="menulargo">Programa de Tecnología en Cómputo (PROTECO)</div></a></li>
                                                </ul>
                                    		</li>
                                    	</ul>
                                    </li>
                                    <li><a href="#"><div>Académicos</div></a>
                                    	<ul>
                                            ...
                                            <li><a href="https://ssa.ingenieria.unam.mx/horarios.html" target="_blank">Horarios de asignaturas</a></li>
                                            <li><a href="http://www.ingenieria.unam.mx/%7Ecentrodedocencia/" target="_blank"><div>Centro de Docencia</div></a></li>
                                            ...
                                            <li><a href="http://dgapa.unam.mx" target="_blank">
                                    ...
                                    <li><a href="#"><div>Publicaciones</div></a>
                                    	<ul>
                                            ...
                                            <li><a href="#"><div>Boletines</div></a>
                                            	<ul>
                                                	<li><a href="../publicaciones/boletinmyc/index.php" target="_blank"><div>Matemáticas y Cultura</div></a></li>
                                    ...
                                    <li><a href="#"><div>Medios de comunicación</div></a>
                                    	<ul>
                                            ...
                                            <li><a href="http://www.comunicacionfi.unam.mx/sissco.php" target="_blank"><div>SISSCO</div></a></li>
                                        </ul>
                                    </li>
                               </ul>
                            </li>
                            <li><a href="#"><div>Programas académicos <img src="../images/icons/mainsubmenured2.png" alt="Submenu"></div></a>
                            	<ul>
                                    ...
                                    <li><a href="#"><div>Posgrado</div></a>
                                    	<ul>
                                        	<li><a href="http://www.ingenieria.unam.mx/spifi/especial1.html" target="_blank"><div>Especializaciones</div></a></li>
                                            <li><a href="http://www.ingenieria.unam.mx/spifi/posgrado1.html" target="_blank"><div>Maestría y Doctorado</div></a></li>
                                        </ul>
                                    </li>
                            ...
                            <li><a href="#"><div>Investigación <img src="../images/icons/mainsubmenured2.png" alt="Submenu"></div></a>
                            	<ul>
                                    ...
                                    <li><a href="../pdf/proyectos/papime_papiit_2019.pdf" target="_blank"><div>Proyectos institucionales</div></a></li>
                                </ul>
                            </li>
                            <li><a href="#" target="_blank"><div>Vinculación <img src="../images/icons/mainsubmenured2.png" alt="Submenu"></div></a>
                            	<ul>
        ...
        <section id="page-title">
            ...
            <div class="container clearfix">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="../nuestra_facultad/nuestra_facultad.php">Nuestra Facultad</a></li>
                    <li class="active">Imagen Institucional</li>
                </ol>
            </div>
                ...
                <div class="container clearfix">
                    ...
                    <div class="single-post nobottommargin">
                        ...
                        <div class="entry clearfix">
                            ...
                            <h3>Escudo</h3>
                    <div class="col_half">
                       <div class="center"><img src="images/institucionales/escudo_fi_color.png"></div>
                    </div>

                    <div class="col_half col_last">
                        <p>El escudo de la Facultad de Ingeniería está representado por los mismos elementos que aparecen en el escudo de la UNAM; el águila, el cóndor, los volcanes, la semiguirnalda de nopales y el glifo. Al centro del escudo aparece el triángulo de equilibrio universal en cuyo centro se encuentra un círculo dividido en cuatro cuadrantes que representan los puntos cardinales, en los que se apoya cualquier proyecto de ingeniería. Se muestra también, de manera simbólica un teodolito que representa la exactitud de la línea y se incluye un sector circular que significa la permanencia en el tiempo de las obras de ingeniería. </p>
                    </div>
                    ...
                    <ul class="clients-grid nobottommargin clearfix">
                        <li><a href="#"><img src="images/institucionales/escudos/escudofi_negro.jpg" alt="Escudo FI negro"></a></li>
                        <li><a href="#"><img src="images/institucionales/escudos/escudofi_rojo.jpg" alt="Escudo FI rojo"></a></li>
                        <li><a href="#"><img src="images/institucionales/escudos/escudofi_azul.jpg" alt="Escudo FI azul"></a></li>
                        <li><a href="#"><img src="images/institucionales/escudos/escudofi_blanco.jpg" alt="Escudo FI blanco"></a></li>
                        <li><a href="#"><img src="images/institucionales/escudos/escudofi_color.jpg" alt="Escudo FI color"></a></li>
                        <li><a href="#"><img src="images/institucionales/escudos/escudounam_negro.jpg" alt="Escudo UNAM negro"></a></li>
                        <li><a href="#"><img src="images/institucionales/escudos/escudounam_rojo.jpg" alt="Escudo UNAM rojo"></a></li>
                        <li><a href="#"><img src="images/institucionales/escudos/escudounam_azul.jpg" alt="Escudo UNAM azul"></a></li>
                        <li><a href="#"><img src="images/institucionales/escudos/escudounam_blanco.jpg" alt="Escudo UNAM blanco"></a></li>
                        <li><a href="#"><img src="images/institucionales/escudos/escudounam_color.jpg" alt="Escudo UNAM color"></a></li>
                    </ul>
                    ...
                    <div class="divider"><i class="icon-circle"></i></div>
                                ...
                                <div class="tagcloud clearfix bottommargin">
                                    ...
                                    <a href="reconocimientos.php">Reconocimientos</a>
                                ...
                                <div class="si-share noborder clearfix">
                                    ...
                                    <div>
                                        <a href="http://www.facebook.com/sharer.php?u=http://www.ingenieria.unam.mx/nuestra_facultad/imagen_institucional.php" class="social-icon si-borderless si-facebook" target="_blank">
                                            <i class="icon-facebook"></i>
                                            <i class="icon-facebook"></i>
                                        </a>
                                        <a href="http://twitter.com/home?status=http://www.ingenieria.unam.mx/nuestra_facultad/imagen_institucional.php" class="social-icon si-borderless si-twitter" target="_blank">
                        ...
                        <div class="widget clearfix">
                           ...
                           <div class="col_one_third">
                                  ...
                                  <div style="padding-left:40px">
                                 	<p><a href="contacto.php" class="btn btn-local">Contacto</a></p>
                            ...
                            <div class="col_two_third col_last">
                                    ...
                                    <strong>Teléfono:</strong>&nbsp;56 22 08 66<br>
                                    <strong>Fax:</strong>&nbsp;56 16 28 90<br>
                                    <strong>eMail:</strong>&nbsp;fainge@unam.mx<br>
                                
                                    <a href="https://www.facebook.com/gacetadigitalfi.unam" class="social-icon si-small si-rounded topmargin-sm si-facebook" data-toggle="tooltip" data-placement="top" title="Facebook" target="_blank">
                                        <i class="icon-facebook"></i>
                                        <i class="icon-facebook"></i>
                            		</a>
            ...
            <div id="copyrights2">
                ...
                <div class="container clearfix">
                        ...
                        <div class="copyrights2">
                        	 Todos los derechos reservados &copy; 1999 - 2019 /
